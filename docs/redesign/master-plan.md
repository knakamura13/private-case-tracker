...
- Tinted-blush card: avatar + "Kyle invited you" → display heading "You're invited to _our_ case." → description → password input + Accept button + invite metadata mono
...
### Phase 10 — Quick Links Page _(pending Q4)_
