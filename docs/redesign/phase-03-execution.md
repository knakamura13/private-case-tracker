...
/* Title adjustments */
h1 { font-family: var(--font-display); font-size: 56px; line-height: 1; margin-bottom: 24px; }
h2 { font-family: var(--font-display); font-size: 36px; line-height: 1.1; margin-bottom: 20px; }
h3 { font-family: var(--font-display); font-size: 24px; line-height: 1.2; margin-bottom: 16px; }
```
