                ...
                <div style={{ padding: '32px 32px 48px', flex: 1, maxWidth: 880 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                        ...
                        <div className="card" style={{ padding: 28 }}>
                            <div className="display" style={{ fontSize: 24, marginBottom: 16 }}>
                                Members
                            </div>
                            {[
                        ...
                        {/* Danger */}
                        <div className="card" style={{ padding: 28 }}>
                            <div className="display" style={{ fontSize: 22, marginBottom: 14, color: 'var(--blush-d)' }}>
                                Sign out
                            </div>
                            <button className="btn">
                                <IconLogout size={15} /> Sign out of this device
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div style={{ width: 420 }}>
                ...
                <div className="card" style={{ padding: 36 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                        ...
                        <button className="btn ghost sm" style={{ alignSelf: 'center', color: 'var(--ink-3)' }}>
                            Forgot password?
                        </button>
                    </div>
                </div>
            ...
            <div style={{ width: 480 }}>
                <div className="card tinted-blush" style={{ padding: 40, textAlign: 'center' }}>
                    ...
                    <h1 className="display" style={{ fontSize: 40, marginBottom: 14 }}>
                        You're invited to <em style={{ fontStyle: 'italic' }}>our</em> case.
                    </h1>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        {[
                            ...
                            >
                                ...
                                >
                                    {opt.active && (
                                        <div style={{ width: 8, height: 8, borderRadius: 999, background: 'var(--butter-fill)' }} />
                                    )}
                                </div>
                                <div style={{ flex: 1 }}>
