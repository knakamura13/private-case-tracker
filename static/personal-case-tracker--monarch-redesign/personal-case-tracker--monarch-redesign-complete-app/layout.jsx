    ...
    return (
        ...
        >
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '0 8px' }}>
                ...
                />
                <div className="display" style={{ fontSize: 24, lineHeight: 1, letterSpacing: '-0.01em' }}>
                    monarch
                </div>
            </div>
            ...
            <div style={{ marginTop: 'auto' }}>
                ...
                >
                    ...
                    <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 4, lineHeight: 1.3 }}>USCIS biometrics</div>
                ...
                >
                    <div style={{ display: 'flex' }}>
                        <div className="avatar sm sage" style={{ border: '2px solid var(--bg)' }}>
                            K
                        </div>
                        <div className="avatar sm blush" style={{ border: '2px solid var(--bg)', marginLeft: -8 }}>
                            A
                        </div>
                    </div>
    ...
    return (
        ...
        >
            <div>
                ...
                <h1 className="display" style={{ fontSize: 56, lineHeight: 1 }}>
                    {title}
                </h1>
                {sub && (
                    <p style={{ color: 'var(--ink-2)', marginTop: 12, fontSize: 15, maxWidth: 560, lineHeight: 1.5, textWrap: 'pretty' }}>
                        {sub}
                    </p>
                )}
            </div>
...
function ByAvatar({ who }) {
    ...
    const ltr = who === 'k' ? 'K' : 'A';
    return (
        <div className={`avatar sm ${cls}`} style={{ width: 22, height: 22, fontSize: 10 }}>
            {ltr}
        </div>
    );
}
