/* global React */
const { Sidebar, Topbar, PageHeader, Sparkline, StatusPill, ByAvatar,
  IconCalendar, IconCheckSq, IconDoc, IconQuestion, IconLink,
  IconPlus, IconChev, IconClock, IconMore, IconFolder, IconCheck } = window;
      ...
      <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "32px 32px 48px", flex: 1 }}>
          <PageHeader
            ...
            title={<>Hello, <em style={{ fontStyle: "italic" }}>Kyle</em></>}
          ...
          <div className="bento">
            ...
            <div className="card span-8" style={{ padding: 36 }}>
              <div className="eyebrow" style={{ marginBottom: 12 }}>Case progress</div>
                  ...
                  <React.Fragment key={i}>
                    <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 8, position: "relative" }}>
                      <div style={{
                        ...
                        background: step.s === "done" ? "var(--sage-fill)"
                                  : step.s === "active" ? "var(--ink)"
                                  : "var(--surface-3)",
                      ...
                      <span style={{ fontSize: 10, color: step.s === "future" ? "var(--ink-4)" : "var(--ink-2)", textAlign: "center", lineHeight: 1.2, fontWeight: step.s === "active" ? 600 : 400 }}>{step.l}</span>
                    </div>
                    {i < 8 && <div style={{ height: 2, flex: 0.5, background: i < 2 ? "var(--sage-fill)" : "var(--surface-3)", marginTop: -22, alignSelf: "center" }} />}
                  </React.Fragment>
                ))}
              </div>
            ...
            <div className="card tinted-peri span-4" style={{ padding: 28 }}>
              <div className="eyebrow" style={{ marginBottom: 10 }}>Time at USCIS</div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginBottom: 6 }}>
                <span className="display" style={{ fontSize: 64, lineHeight: 1 }}>47</span>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", marginTop: 6 }}>
                <span className="mono" style={{ fontSize: 10, color: "oklch(0.42 0.15 265)" }}>Mar 14</span>
                <span className="mono" style={{ fontSize: 10, color: "oklch(0.42 0.15 265)" }}>today</span>
              </div>
            </div>
            ...
            <div className="card span-7" style={{ padding: 28 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 18 }}>
                <div>
                  <div className="eyebrow" style={{ marginBottom: 8 }}>This week · 4 of 7</div>
                  <h3 className="display" style={{ fontSize: 28 }}>What we can do now</h3>
                </div>
                <button className="btn sm">All tasks <IconChev size={14} /></button>
              </div>
                ...
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{
                      ...
                      border: "2px solid " + (task.done ? "var(--sage-d)" : task.urgent ? "var(--blush-d)" : "var(--ink-3)"),
                    ...
                    <span style={{ flex: 1, fontSize: 14, color: task.done ? "var(--ink-3)" : "var(--ink)", textDecoration: task.done ? "line-through" : "none" }}>{task.t}</span>
                    <ByAvatar who={task.who} />
                    <span className="mono" style={{ fontSize: 11, color: task.urgent ? "var(--blush-d)" : "var(--ink-3)", minWidth: 64, textAlign: "right" }}>{task.due}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="card tinted-butter span-5" style={{ padding: 28 }}>
              ...
              <h3 className="display" style={{ fontSize: 28, marginBottom: 18 }}>The next 60 days</h3>
                ...
                {[
                  ...
                  <div key={i} style={{ display: "flex", gap: 14, alignItems: "center" }}>
                    <div style={{
                      ...
                      <span className="display" style={{ fontSize: 22 }}>{e.n}</span>
                    </div>
            ...
            <div className="card span-4" style={{ padding: 24 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                ...
                <span className="mono" style={{ fontSize: 11, color: "var(--ink-3)" }}>4</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {[
                  ...
                  <div key={i} style={{ padding: 12, borderRadius: 12, background: "var(--surface-2)" }}>
                    ...
                    <span className={`pill ${q.c}`} style={{ height: 22, fontSize: 11 }}>{q.t}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Evidence progress */}
            <div className="card span-4" style={{ padding: 24 }}>
              <div className="eyebrow" style={{ marginBottom: 14 }}>Evidence collected</div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginBottom: 4 }}>
                <span className="display" style={{ fontSize: 48 }}>24</span>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {[
                  ...
                  <div key={c.l} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12 }}>
                    ...
                    <span className="mono" style={{ color: "var(--ink-3)" }}>{c.c}/{c.t}</span>
                  </div>
                ))}
              </div>
            </div>
                  ...
                  return (
                    <a key={i} style={{
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div className="mono" style={{ fontSize: 10, color: "var(--ink-3)" }}>{l.s}</div>
                      </div>
                    </a>
                  );
                })}
              ...
              <div style={{ padding: "20px 24px 14px", borderBottom: "1px solid var(--hairline)" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <IconCheckSq size={18} />
                    <div className="display" style={{ fontSize: 22 }}>Tasks</div>
                  </div>
                  <span className="mono" style={{ fontSize: 11, color: "var(--ink-3)" }}>4 of 7</span>
                </div>
              </div>
              <div style={{ padding: "8px 12px 16px" }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 10 }}>
                    <div style={{ width: 16, height: 16, borderRadius: 999, border: "1.5px solid " + (t.urgent ? "var(--blush-d)" : "var(--ink-3)") }} />
                    <span style={{ fontSize: 13, flex: 1 }}>{t.t}</span>
                    <ByAvatar who={t.who} />
                    <span className="mono" style={{ fontSize: 10, color: t.urgent ? "var(--blush-d)" : "var(--ink-3)" }}>{t.due}</span>
                  </div>
                ))}
                <button className="btn sm" style={{ marginTop: 8, width: "100%", justifyContent: "center" }}><IconPlus size={13} /> Add task</button>
              </div>
            </div>
              ...
              <div style={{ padding: "20px 24px 14px", borderBottom: "1px solid var(--hairline)" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div className="display" style={{ fontSize: 22 }}>Milestones</div>
                  </div>
                  <span className="mono" style={{ fontSize: 11, color: "var(--ink-3)" }}>3 / 9</span>
                </div>
              </div>
              <div style={{ padding: 16 }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", gap: 12, padding: "8px 0", alignItems: "center" }}>
                    <div style={{ width: 10, height: 10, borderRadius: 999, background: m.s === "done" ? "var(--sage-fill)" : m.s === "active" ? "var(--ink)" : "var(--surface-3)", flexShrink: 0 }} />
                    <span className="mono" style={{ fontSize: 11, color: "var(--ink-3)", width: 60 }}>{m.d}</span>
              ...
              <div style={{ padding: "20px 24px 14px", borderBottom: "1px solid var(--hairline)" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div className="display" style={{ fontSize: 22 }}>Open questions</div>
                  </div>
                  <span className="mono" style={{ fontSize: 11, color: "var(--ink-3)" }}>4</span>
                </div>
              </div>
              <div style={{ padding: "8px 16px 16px" }}>
                {[
                  ...
                  <div key={i} style={{ padding: "10px 12px", borderRadius: 10 }}>
                    ...
                    <span className={`pill ${q.c}`} style={{ height: 22, fontSize: 10 }}>{q.t}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 20, marginTop: 20 }}>
            <div className="card" style={{ padding: 28 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <IconDoc size={18} />
                  <div className="display" style={{ fontSize: 24 }}>Evidence collection</div>
                </div>
                <span className="mono" style={{ fontSize: 12, color: "var(--ink-3)" }}>24 / 38</span>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
                {[
                  ...
                  <div key={c.l} className="card-tight" style={{ background: c.color, border: "1px solid transparent", padding: 16 }}>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 6, marginBottom: 8 }}>
                      <span className="display" style={{ fontSize: 32 }}>{c.c}</span>
                      <span className="mono" style={{ fontSize: 11, color: "var(--ink-2)" }}>/ {c.t}</span>
                    </div>
                    <div style={{ fontSize: 12, marginBottom: 10 }}>{c.l}</div>
                    <div style={{ height: 4, borderRadius: 4, background: "var(--surface)" }}>
                      <div style={{ width: `${c.c/c.t*100}%`, height: "100%", borderRadius: 4, background: c.fill }} />
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="card" style={{ padding: 24 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <IconLink size={18} />
                  <div className="display" style={{ fontSize: 22 }}>Quick links</div>
                </div>
                <button className="btn ghost sm"><IconPlus size={13} /></button>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, padding: "4px 4px 8px" }}>
                {[
                  ...
                  { kind: "folder", label: "Government",  color: "blush",
                    children: [
                      { glyph: "C", color: "blush" },
                      { glyph: "S", color: "peri" },
                  ...
                  { kind: "folder", label: "Translations", color: "lilac",
                    children: [
                      { glyph: "B", color: "blush" },
                  ...
                  <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, cursor: "pointer" }}>
                    {it.kind === "link" && (
                      <div style={{
                        ...
                        <span className="display" style={{ fontSize: 26, color: "var(--ink)", lineHeight: 1 }}>{it.glyph}</span>
                      </div>
                    )}
                    {it.kind === "folder" && (
                      <div style={{
                        ...
                        {[0,1,2,3].map(ci => {
                          ...
                          return (
                            <div key={ci} style={{
                              ...
                              {c && <span style={{ fontFamily: "var(--font-display)", fontSize: 11, color: "var(--ink)" }}>{c.glyph}</span>}
                            </div>
                          );
                        })}
                      </div>
                    ...
                    <div style={{ fontSize: 11, fontWeight: 500, textAlign: "center", lineHeight: 1.2, maxWidth: 64,
