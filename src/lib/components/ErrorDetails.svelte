...
<div class="errdetails-rounded-lg errdetails-border errdetails-bg-card errdetails-p-4 errdetails-text-left errdetails-shadow-sm">
    <div class="errdetails-flex errdetails-flex-wrap errdetails-items-start errdetails-justify-between errdetails-gap-3">
        <div class="errdetails-min-w-0">
            <div class="errdetails-flex errdetails-flex-wrap errdetails-items-center errdetails-gap-2">
                {#if status != null}
                    <span
                        class="errdetails-inline-flex errdetails-items-center errdetails-rounded-md errdetails-bg-muted errdetails-px-2 errdetails-py-0-5 errdetails-text-xs errdetails-font-medium errdetails-text-foreground"
                    >
                        {status}
                    </span>
                {/if}
                <p
                    class="errdetails-min-w-0 errdetails-wrap-break-word errdetails-text-sm errdetails-font-medium errdetails-text-foreground"
                >
                    {message}
                </p>
            </div>
    ...
    {#if stack}
        <details class="errdetails-mt-3">
            <summary
                class="errdetails-cursor-pointer errdetails-text-xs errdetails-font-medium errdetails-text-muted errdetails-hover-text-foreground"
            >
                Show details
            </summary>
            <pre
