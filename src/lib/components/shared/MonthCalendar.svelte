...
<div class="monthcal-rounded-lg monthcal-border monthcal-bg-card">
    ...
    <div
        class="monthcal-grid monthcal-grid-cols-7 monthcal-border-b monthcal-bg-muted-30 monthcal-text-center monthcal-text-xs monthcal-text-muted"
    >
    ...
    <div class="monthcal-grid monthcal-grid-cols-7">
        {#each cells as cell (cell.date.toISOString())}
            ...
            <div
                class="monthcal-min-h-90 monthcal-border-b monthcal-border-r monthcal-p-1 monthcal-text-xs {current
                    ? ''
                    : 'monthcal-bg-muted-20 monthcal-text-muted'}"
            >
